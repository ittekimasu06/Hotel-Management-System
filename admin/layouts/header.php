...
<head>
  ...
  <title>Hostay Admin</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="/hostay/assets/img-admin/favicon.png" rel="icon">
  <link href="/hostay/assets/img-admin/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <link href="/hostay/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="/hostay/assets/vendor/quill/quill.snow.css" rel="stylesheet">
  <link href="/hostay/assets/vendor/quill/quill.bubble.css" rel="stylesheet">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="/hostay/logout.php?redirect=admin">
