...
-- Thời gian đã tạo: Th9 05, 2024 lúc 03:07 PM
...
CREATE TABLE `tblbill` (
  ...
  `bill_room_id` int UNSIGNED NOT NULL,
  `bill_customer_id` int UNSIGNED NOT NULL,
  `bill_created_at` datetime NOT NULL,
  `bill_fullname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `bill_number_adult` int UNSIGNED DEFAULT '0',
  `bill_number_children` int UNSIGNED DEFAULT '0',
  `bill_number_room` int UNSIGNED DEFAULT '1',
  `bill_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `bill_static` int UNSIGNED DEFAULT '0',
  `bill_is_paid` tinyint(1) DEFAULT '0',
  `bill_cancel` tinyint UNSIGNED DEFAULT '0',
  `bill_staff_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
(19, 27, 15, '2024-08-30 00:00:00', 'Son Tung MTP', 'nghiadaica@gmail.com', '12121212', '2024-08-30 00:00:00', '2024-08-30 00:00:00', 1, 0, 1, 'không', 1, 1, 0, NULL),
(20, 42, 27, '2024-08-30 00:00:00', 'Nghĩa Trần Quang', 'niboss458@gmail.com', '0366461704', '2024-08-30 00:00:00', '2024-09-06 00:00:00', 2, 0, 1, '', 1, 0, 0, NULL),
(21, 46, 27, '2024-08-30 00:00:00', 'Nghĩa Trần Quang', 'niboss458@gmail.com', '0366461704', '2024-08-30 00:00:00', '2024-08-31 00:00:00', 1, 0, 1, '', 1, 0, 1, NULL);
...
CREATE TABLE `tblbillstatic` (
  `billstatic_id` int UNSIGNED NOT NULL,
  `billstatic_name` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `billstatic_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tblcontact` (
  ...
  `contact_fullname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_subject` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_seen` tinyint UNSIGNED DEFAULT '0',
...
(5, 'Trần Quang Nghĩa', 'nghiadaica@gmail.com', 'Khiếu nại', 'Mất đồ', 0, '2024-08-30 00:00:00');
...
CREATE TABLE `tblroom` (
  ...
  `room_number_people` int UNSIGNED DEFAULT NULL,
  `room_number_bed` int UNSIGNED DEFAULT NULL,
  `room_quality` float DEFAULT NULL,
  `room_bed_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `room_price` decimal(18,2) NOT NULL,
  `room_detail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `room_area` float NOT NULL,
  `room_static` int UNSIGNED DEFAULT '0',
  `room_image` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `room_address` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `room_hotel_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tblroomtype` (
  ...
  `roomtype_name` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `roomtype_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tbluser` (
  ...
  `user_fullname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `user_permission` int UNSIGNED DEFAULT '0',
...
(15, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Trần Quang Nghĩa', 'nghiadaica@gmail.com', '0366461704', 5, '2023-11-20 00:00:00'),
...
(27, 'nghia', '21232f297a57a5a743894a0e4a801fc3', 'Trần Quang Nghĩa', 'nghiatq@gmail.com', '0366461704', 0, '2023-12-12 00:00:00'),
...
--
ALTER TABLE `tblbill`
  MODIFY `bill_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT cho bảng `tblbillstatic`
--
ALTER TABLE `tblbillstatic`
  MODIFY `billstatic_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tblroom`
  MODIFY `room_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT cho bảng `tblroomtype`
--
ALTER TABLE `tblroomtype`
  MODIFY `roomtype_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `tbluser`
--
ALTER TABLE `tbluser`
  MODIFY `user_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
COMMIT;
